...
public class DataImporter {
	...
	// } catch (Exception e) {
	// System.out
	// .println("130802-0040 Daten f�r Investition fehlerhaft");
	// }
	// } else {
	// System.out
	// .println("130802-0033 Daten f�r Investition fehlerhaft");
	// }
	...
	// } catch (Exception e) {
	// System.out
	// .println("130802-0044 Daten f�r Mietzinsbeitrag fehlerhaft");
	// }
	// } else {
	// System.out
	// .println("130802-0042 Daten f�r Mietzinsbeitrag fehlerhaft");
	// }
